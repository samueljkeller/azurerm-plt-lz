...
custom_replacements = {
  ...
  */
  names = {
    ...
    management_resource_group_name                 = "rg-alz-management-$${starter_location_01}"
    connectivity_hub_vwan_resource_group_name      = "rg-alz-hub-vwan-$${starter_location_01}"
    connectivity_hub_primary_resource_group_name   = "rg-alz-hub-$${starter_location_01}"
    connectivity_hub_secondary_resource_group_name = "rg-alz-hub-$${starter_location_02}"
    dns_resource_group_name                        = "rg-alz-hub-dns-$${starter_location_01}"
    ddos_resource_group_name                       = "rg-alz-hub-ddos-$${starter_location_01}"
    asc_export_resource_group_name                 = "rg-alz-asc-export-$${starter_location_01}"
    service_health_alerts_resource_group_name      = "rg-service-health-alerts-$${starter_location_01}"

    # Resource names
    log_analytics_workspace_name            = "alz-law-management-$${starter_location_01}"
    ddos_protection_plan_name               = "alz-ddos-$${starter_location_01}"
    ama_user_assigned_managed_identity_name = "alz-uami-management-ama-$${starter_location_01}"
    dcr_change_tracking_name                = "alz-dcr-change-tracking"
    dcr_defender_sql_name                   = "alz-dcr-defender-sql"
    dcr_vm_insights_name                    = "alz-dcr-vm-insights"

    # Resource names primary connectivity
    primary_hub_name                                   = "alz-vwan-hub-$${starter_location_01}"
    primary_sidecar_virtual_network_name               = "alz-vnet-sidecar-$${starter_location_01}"
    primary_firewall_name                              = "alz-fw-hub-$${starter_location_01}"
    primary_firewall_policy_name                       = "alz-fwp-hub-$${starter_location_01}"
    primary_virtual_network_gateway_express_route_name = "alz-vgw-hub-er-$${starter_location_01}"
    primary_virtual_network_gateway_vpn_name           = "alz-vgw-hub-vpn-$${starter_location_01}"
    primary_private_dns_resolver_name                  = "alz-pdr-hub-dns-$${starter_location_01}"
    primary_bastion_host_name                          = "alz-bas-hub-$${starter_location_01}"
    primary_bastion_host_public_ip_name                = "alz-pip-bastion-hub-$${starter_location_01}"

    # Resource names secondary connectivity
    secondary_hub_name                                   = "alz-vwan-hub-$${starter_location_02}"
    secondary_sidecar_virtual_network_name               = "alz-vnet-sidecar-$${starter_location_02}"
    secondary_firewall_name                              = "alz-fw-hub-$${starter_location_02}"
    secondary_firewall_policy_name                       = "alz-fwp-hub-$${starter_location_02}"
    secondary_virtual_network_gateway_express_route_name = "alz-vgw-hub-er-$${starter_location_02}"
    secondary_virtual_network_gateway_vpn_name           = "alz-vgw-hub-vpn-$${starter_location_02}"
    secondary_private_dns_resolver_name                  = "alz-pdr-hub-dns-$${starter_location_02}"
    secondary_bastion_host_name                          = "alz-bas-hub-$${starter_location_02}"
    secondary_bastion_host_public_ip_name                = "alz-pip-bastion-hub-$${starter_location_02}"
